...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 dwc3_msm.cpu_to_affin=1 selinux=permissive
 BOARD_KERNEL_BASE := 0x00000000BOARD_KERNEL_PAGESIZE := 4096
